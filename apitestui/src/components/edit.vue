...
export default {
  ...
  methods: {
    ...
    loadData() {
      this.$get(`/api/api/${this.id}/`).then(res => {
        console.log(res);
        const data = res.data;
        ...
        if(data.case_postpostposition === 'null' ) data.case_postpostposition = [];
        Object.assign(this.form, data);

        this.form.case_replace = JSON.parse(data.case_replace);
        this.form.case_check = JSON.parse(data.case_check);
        this.form.case_save = JSON.parse(data.case_save);
        this.form.case_postpostposition = JSON.parse(data.case_postpostposition);
      })
    },
    submitForm() {
