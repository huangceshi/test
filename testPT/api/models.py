...
class Api(models.Model):
    ...
    case_replace=models.CharField(verbose_name='用例替换参数',max_length=450,null=True)
    case_file_name=models.CharField(verbose_name='文件上传名称',max_length=450,null=True)
    ...
    case_save =models.CharField(verbose_name='用例保存参数',max_length=450,null=True)
    case_postpostposition = models.CharField(verbose_name='后置处理', max_length=450,null=True)
