# Generated by Django 3.1.3 on 2020-11-11 06:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('casename', models.CharField(max_length=45, unique=True, verbose_name='用例名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('platform', models.CharField(max_length=45, unique=True, verbose_name='平台')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('run_url', models.CharField(max_length=45, verbose_name='运行结果链接')),
                ('createtime', models.DateTimeField(verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('usr_key', models.CharField(max_length=45, verbose_name='保留字段名')),
                ('user_value', models.CharField(max_length=45, verbose_name='保留字段值')),
                ('createtime', models.DateTimeField(verbose_name='创建时间')),
