    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_replace', models.CharField(max_length=4500, null=True, verbose_name='用例替换参数')),
                ('case_file_name', models.CharField(max_length=500, null=True, verbose_name='文件上传名称')),
                ...
                ('case_save', models.CharField(max_length=1000, null=True, verbose_name='用例保存参数')),
                ('case_postpostposition', models.CharField(max_length=4500, null=True, verbose_name='后置处理')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=45, unique=True, verbose_name='邮箱')),
            ],
        ),
        migrations.CreateModel(
            name='Run',
