# Generated by Django 3.1.3 on 2020-11-27 11:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_url', models.CharField(max_length=45000, null=True, verbose_name='用例请求地址')),
                ('case_data', models.CharField(max_length=5000000000, null=True, verbose_name='用例请求参数')),
                ('case_replace', models.CharField(max_length=45000, null=True, verbose_name='用例替换参数')),
                ...
                ('case_check', models.CharField(max_length=450000, null=True, verbose_name='用例检查点')),
                ('case_save', models.CharField(max_length=450000, null=True, verbose_name='用例保存参数')),
                ('case_postpostposition', models.CharField(max_length=45000, null=True, verbose_name='后置处理')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runsave', models.JSONField(max_length=4500, null=True, verbose_name='运行结果链接')),
                ...
                ('modular', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.modular', verbose_name='用户执行id')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.user', verbose_name='用户执行id')),
            ],
        ),
        migrations.CreateModel(
            name='Notice',
